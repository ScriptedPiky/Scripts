...
class ThaumicMachina : Runnable {
    override fun run() {
        ...
        Arcane.addShaped("@WAND_AUGMENTATION", ItemBracketHandler.getItem("ThaumicMachina:wandAugmentationCore", 0), "ordo 35, perditio 35", arrayOf(arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)), arrayOf(OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 10), OreBracketHandler.getOre("plateEnergeticAlloy")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14))))
        Research.addArcanePage("@WAND_AUGMENTATION", ItemBracketHandler.getItem("ThaumicMachina:wandAugmentationCore", 0))
        ...
        Research.setAspects("@CRIMSON_CELESTIAL_FIELD", "alienis 3, auram 12, tenebrae 6, praecantatio 9, ordo 15, vacuos 18")
        ...
        Research.setAspects("@CRIMSON_WAND_AUGMENTATION", "alienis 3, tenebrae 6, instrumentum 12, praecantatio 9, ordo 15, machina 18, cognitio 21")
        Research.setComplexity("@CRIMSON_WAND_AUGMENTATION", 3)
        Research.setAspects("@WAND_AUGMENTATION_TAINTED_CORE", "instrumentum 3, praecantatio 6, perditio 12, vitium 9, tenebrae 15, alienis 18, cognitio 21")
        Research.setComplexity("@WAND_AUGMENTATION_TAINTED_CORE", 3)
        Warp.addToResearch("@WAND_AUGMENTATION_TAINTED_CORE", 5)
        Research.setAspects("@WAND_AUGMENTATION_CHARGE_BUFFER", "instrumentum 3, praecantatio 6, potentia 12, vacuos 9, tenebrae 15, alienis 18")
        Research.setComplexity("@WAND_AUGMENTATION_CHARGE_BUFFER", 3)
        Research.setAspects("@WAND_AUGMENTATION_VIS_CHANNEL", "instrumentum 3, praecantatio 6, aqua 9, tenebrae 12, alienis 15")
        Research.setComplexity("@WAND_AUGMENTATION_VIS_CHANNEL", 3)
        Research.setAspects("@WAND_AUGMENTATION_CONTACT_DISCHARGE", "instrumentum 3, praecantatio 6, potentia 12, tenebrae 15, alienis 18, telum 21")
        Research.setComplexity("@WAND_AUGMENTATION_CONTACT_DISCHARGE", 3)
        Warp.addToResearch("@WAND_AUGMENTATION_CONTACT_DISCHARGE", 5)
        Research.setAspects("@WAND_AUGMENTATION_TAINT_CAPPING", "instrumentum 3, praecantatio 6, vitium 9, auram 12, alienis 15, potentia 18, cognitio 21")
