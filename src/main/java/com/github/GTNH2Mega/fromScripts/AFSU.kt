...
class AFSU : Runnable {
    override fun run() {
        ...
        Assembler.addRecipe(ItemBracketHandler.getItem("AFSU:ALC", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.03", 32086), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32597), 2400, EV)
        Assembler.addRecipe(ItemBracketHandler.getItem("AFSU:ALC", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.03", 32084), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32597), 2400, EV)
        Assembler.addRecipe(ItemBracketHandler.getItem("AFSU:ALC", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.03", 32089), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32597), 2400, EV)
    }
}