...
class Ztones : Runnable {
    override fun run() {
        ...
        Assembler.addRecipe(ItemBracketHandler.getItem("Ztones:cleanDirt", 0).amount(8),
                ItemBracketHandler.getItem("minecraft:sand", 32767).amount(4),
                ItemBracketHandler.getItem("minecraft:dirt", 32767).amount(4),
        ...
        Assembler.addRecipe(ItemBracketHandler.getItem("Ztones:booster", 0),
                ...
                LiquidBracketHandler.getLiquid("molten.blaze").withAmount(8), 100, 30)
        Assembler.addRecipe(ItemBracketHandler.getItem("Ztones:auroraBlock", 0).amount(8),
                ...
                ItemBracketHandler.getItem("minecraft:dye", 32767), 160, 4)
