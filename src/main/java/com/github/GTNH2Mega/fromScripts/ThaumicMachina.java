...
implements Runnable {
    public void run() {
        ...
        Arcane.addShaped("@WAND_AUGMENTATION", ItemBracketHandler.getItem("ThaumicMachina:wandAugmentationCore", 0), "ordo 35, perditio 35", new IIngredient[][]{{ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)}, {OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 10), OreBracketHandler.getOre("plateEnergeticAlloy")}, {ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), OreBracketHandler.getOre("plateEnergeticAlloy"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)}});
