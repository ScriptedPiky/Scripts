...
class Spiceoflife : Runnable {
    override fun run() {
        MineTweakerAPI.recipes.remove(ItemBracketHandler.getItem("SpiceOfLife:lunchbag", 0) as IIngredient)
        MineTweakerAPI.recipes.remove(ItemBracketHandler.getItem("SpiceOfLife:lunchbox", 0) as IIngredient)
