...
class Emt : Runnable {
    override fun run() {
        ...
        MineTweakerAPI.recipes.addShapeless(ItemBracketHandler.getItem("EMT:EMTItems", 8), arrayOf<IIngredient>(ItemBracketHandler.getItem("TConstruct:materials", 36), ItemBracketHandler.getItem("TConstruct:materials", 36)), null)
        MineTweakerAPI.recipes.addShapeless(ItemBracketHandler.getItem("TConstruct:materials", 36).amount(2), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 8)), null)
        ...
        val array = arrayOf(arrayOf<IIngredient?>(OreBracketHandler.getOre("screwDiamond"), OreBracketHandler.getOre("plateDiamond"), OreBracketHandler.getOre("screwDiamond")), null, null)
        val n4 = 1
        ...
        array[n4] = array2
        array[2] = arrayOf(OreBracketHandler.getOre("craftingToolHardHammer"), OreBracketHandler.getOre("plateDiamond"), OreBracketHandler.getOre("craftingToolWrench"))
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.ElectricCloud1", "All thaumaturges (except Crimson ones, I guess) enjoy the shine and heat of the magic flame called Nitor, aren't they? You desided to make it more... energetic. Well, you did it.<BR><BR>You have created a new kind of magic flame — the Electric Cloud. It behaves and looks like normal Nitor, but it has purple colour and creates light-purple lightning charges around itself. For electrolizing need to click RMB on Nitor with advanced battery(or better) on hand.")
        ...
        Arcane.addShaped("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 7), "aer 5, terra 5, ordo 5", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("minecraft:feather", 0), ItemBracketHandler.getItem("minecraft:feather", 0), ItemBracketHandler.getItem("minecraft:feather", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("minecraft:feather", 0), ItemBracketHandler.getItem("EMT:EMTItems", 9), ItemBracketHandler.getItem("minecraft:feather", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("minecraft:feather", 0), ItemBracketHandler.getItem("minecraft:feather", 0), ItemBracketHandler.getItem("minecraft:feather", 0))))
        Research.addArcanePage("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 11))
        Arcane.addShaped("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 11), "aer 15, ordo 5", arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 21879), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 21879), null), arrayOf<IIngredient?>(ItemBracketHandler.getItem("EMT:EMTItems", 8), ItemBracketHandler.getItem("EMT:EMTItems", 8), null), arrayOfNulls(3)))
        Research.addArcanePage("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 11))
        Arcane.addShaped("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 12), "aer 10, ordo 10", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 7), ItemBracketHandler.getItem("EMT:EMTItems", 8), ItemBracketHandler.getItem("EMT:EMTItems", 11)), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 7), ItemBracketHandler.getItem("minecraft:string", 0), ItemBracketHandler.getItem("EMT:EMTItems", 11)), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 7), ItemBracketHandler.getItem("EMT:EMTItems", 8), ItemBracketHandler.getItem("EMT:EMTItems", 11))))
        Research.addArcanePage("FeatherWings", ItemBracketHandler.getItem("EMT:EMTItems", 12))
        Arcane.addShaped("FeatherWings", ItemBracketHandler.getItem("EMT:FeatherWing", 0), "aer 24, terra 24, ignis 24, aqua 24, ordo 24, perditio 24", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 12), ItemBracketHandler.getItem("minecraft:string", 0), ItemBracketHandler.getItem("EMT:EMTItems", 12)), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 12), OreBracketHandler.getOre("plateAluminium"), ItemBracketHandler.getItem("EMT:EMTItems", 12)), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTItems", 12), ItemBracketHandler.getItem("minecraft:string", 0), ItemBracketHandler.getItem("EMT:EMTItems", 12))))
        ...
        Arcane.addShaped("ThaumiumReinforcedWings", ItemBracketHandler.getItem("EMT:EMTItems", 14), "aer 48, terra 48, ignis 48, aqua 48, ordo 48, perditio 48", arrayOf(arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 13), OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("plateStainlessSteel")), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 13), OreBracketHandler.getOre("wireFineCobalt"), OreBracketHandler.getOre("plateStainlessSteel")), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 13), OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("plateStainlessSteel"))))
        Research.addArcanePage("ThaumiumReinforcedWings", ItemBracketHandler.getItem("EMT:EMTItems", 14))
        Arcane.addShaped("ThaumiumReinforcedWings", ItemBracketHandler.getItem("EMT:ThaumiumWing", 0), "aer 48, terra 48, ignis 48, aqua 48, ordo 48, perditio 48", arrayOf(arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 14), OreBracketHandler.getOre("wireFineCobalt"), ItemBracketHandler.getItem("EMT:EMTItems", 14)), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 14), OreBracketHandler.getOre("wireFineCobalt"), ItemBracketHandler.getItem("EMT:EMTItems", 14)), arrayOfNulls(3)))
        ...
        Infusion.addRecipe("NanosuitWings", ItemBracketHandler.getItem("EMT:ThaumiumWing", 0), arrayOf(ItemBracketHandler.getItem("IC2:itemArmorNanoChestplate", 32767), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19028), ItemBracketHandler.getItem("IC2:itemPartCarbonPlate", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19028), ItemBracketHandler.getItem("IC2:itemPartCarbonPlate", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19028), ItemBracketHandler.getItem("IC2:itemPartCarbonPlate", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19028), ItemBracketHandler.getItem("IC2:itemPartCarbonPlate", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19028)), "aer 48, machina 48, potentia 32, volatus 32, praecantatio 16, vitium 8, terra 8", ItemBracketHandler.getItem("EMT:NanosuitWing", 27), 5)
        ...
        Infusion.addRecipe("QuantumWings", ItemBracketHandler.getItem("EMT:NanosuitWing", 32767), arrayOf(ItemBracketHandler.getItem("IC2:itemArmorQuantumChestplate", 32767), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19083), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19083), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19083), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19083), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19083)), "tutamen 64, aer 64, machina 64, potentia 48, volatus 48, praecantatio 32, vitium 16, terra 16", ItemBracketHandler.getItem("EMT:QuantumWing", 27), 10)
        ...
        Infusion.addRecipe("InfusedQuantumArmor", ItemBracketHandler.getItem("IC2:itemArmorQuantumChestplate", 32767), arrayOf(ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19324), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19324), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19324), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 19324)), "tutamen 72, aer 64, machina 64, potentia 48, volatus 48, praecantatio 32, vitium 16, terra 16, lucrum 8", ItemBracketHandler.getItem("EMT:itemArmorQuantumChestplate", 27), 15)
        ...
        array4[n8] = array5
        array4[1] = arrayOf(OreBracketHandler.getOre("plateIron"), OreBracketHandler.getOre("plateIron"), OreBracketHandler.getOre("plateIron"))
        val n11 = 2
        ...
        Infusion.addRecipe(s42, item8, array9, "instrumentum 32, perfodio 24, potentia 24, metallum 16, telum 16, terra 8", ItemBracketHandler.getItem("EMT:DiamondOmnitool", 27), 6)
        ...
        Infusion.addRecipe("NanoBootsoftheTraveller", ItemBracketHandler.getItem("EMT:ElectricBootsTraveller", 32767), arrayOf(ItemBracketHandler.getItem("IC2:itemArmorNanoBoots", 32767), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32602), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1442), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1442), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32602), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330)), "motus 48, potentia 24, tutamen 32, praecantatio 16, volatus 8, iter 16", ItemBracketHandler.getItem("EMT:NanoBootsTraveller", 27), 6)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.QuantumBootsoftheTraveller", "You have meddled with Quantum Physics, making these Quantum Boots of the Traveller so fast, that you appear to be in multiple places at once. But do not forget what happened to Schrodinger's cat...")
        Infusion.addRecipe("QuantumBootsoftheTraveller", ItemBracketHandler.getItem("EMT:NanoBootsTraveller", 0), arrayOf(ItemBracketHandler.getItem("IC2:itemArmorQuantumBoots", 32767), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32603), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1563), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemBatLamaCrystal", 32767), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1563), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32603), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970)), "motus 64, potentia 32, tutamen 48, praecantatio 24, volatus 16, iter 24, aer 8", ItemBracketHandler.getItem("EMT:QuantumBootsTraveller", 27), 9)
        ...
        Infusion.addRecipe(s54, item10.withTag(ExpandAnyDict.asData(hashMap54)), arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 27028), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17316), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 27028), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17316)), "instrumentum 32, perfodio 16, potentia 32, lucrum 24, praecantatio 8", ItemBracketHandler.getItem("EMT:ThaumiumDrill", 27), 7)
        ...
        Infusion.addRecipe("ThaumiumChainsaw", ItemBracketHandler.getItem("EMT:DiamondChainsaw", 32767), arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 27028), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17316), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 27028), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17316)), "instrumentum 32, telum 24, potentia 24, lucrum 16, praecantatio 8", ItemBracketHandler.getItem("EMT:ThaumiumChainsaw", 27), 7)
        ...
        Arcane.addShaped("ElectricGogglesofRevealing", ItemBracketHandler.getItem("EMT:ElectricGogglesRevealing", 165), "aer 45, ignis 45, terra 45, aqua 45, ordo 45, perditio 45", arrayOf(arrayOf(OreBracketHandler.getOre("wireGt02AnyCopper"), ItemBracketHandler.getItem("minecraft:diamond_helmet", 0), OreBracketHandler.getOre("wireGt02AnyCopper")), arrayOf(OreBracketHandler.getOre("circuitBasic"), ItemBracketHandler.getItem("Thaumcraft:ItemGoggles", 0), OreBracketHandler.getOre("circuitBasic")), arrayOf<IIngredient>(ItemBracketHandler.getItem("ProjRed|Integration:projectred.integration.gate", 10), ItemBracketHandler.getItem("IC2:itemAdvBat", 32767), ItemBracketHandler.getItem("ProjRed|Integration:projectred.integration.gate", 10))))
        ...
        Infusion.addRecipe("QuantumGogglesofRevealing", ItemBracketHandler.getItem("EMT:NanosuitGogglesRevealing", 32767), arrayOf(ItemBracketHandler.getItem("IC2:itemArmorQuantumHelmet", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1563), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32693), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("IC2:itemBatLamaCrystal", 32767), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32693), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32705), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1563)), "tutamen 64, potentia 48, sensus 32, praecantatio 24, auram 16, electrum 16, lucrum 8", ItemBracketHandler.getItem("EMT:QuantumGogglesRevealing", 27), 9)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.SolarHelmetofRevealing", "You now have a helmet that acts exactly like your quantum goggles of revealing, but can also recharge your chest armor! It generates 128 EU/t during the day, and nothing at night.")
        Infusion.addRecipe("SolarHelmetofRevealing", ItemBracketHandler.getItem("EMT:QuantumGogglesRevealing", 32767), arrayOf(ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1624), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17324), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32694), ItemBracketHandler.getItem("dreamcraft:item.MysteriousCrystal", 0), ItemBracketHandler.getItem("IC2:itemBatLamaCrystal", 32767), ItemBracketHandler.getItem("dreamcraft:item.MysteriousCrystal", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32694), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17324), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1624)), "tutamen 64, potentia 48, sensus 32, praecantatio 24, auram 16, electrum 16, lucrum 8, aer 16, lux 32", ItemBracketHandler.getItem("EMT:SolarHelmetRevealing", 27), 12)
        ...
        Arcane.addShaped("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars", 0), "aer 50, aqua 50, terra 50, ignis 50, ordo 50, perditio 50", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("IC2:blockGenerator", 3), ItemBracketHandler.getItem("IC2:blockGenerator", 3), ItemBracketHandler.getItem("IC2:blockGenerator", 3)), arrayOf<IIngredient>(ItemBracketHandler.getItem("IC2:blockGenerator", 3), ItemBracketHandler.getItem("dreamcraft:item.ReinforcedAluminiumIronPlate", 0), ItemBracketHandler.getItem("IC2:blockGenerator", 3)), arrayOf<IIngredient>(ItemBracketHandler.getItem("IC2:blockGenerator", 3), ItemBracketHandler.getItem("IC2:blockGenerator", 3), ItemBracketHandler.getItem("IC2:blockGenerator", 3))))
        Research.addArcanePage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars", 0))
        Arcane.addShaped("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars", 1), "aer 100, aqua 100, terra 100, ignis 100, ordo 100, perditio 100", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTSolars", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTSolars", 0), ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedTitaniumPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("EMT:EMTSolars", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 0))))
        Research.addArcanePage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars", 1))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedTungstenSteelPlate", 0), arrayOf(ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedTungstenSteelPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedTungstenSteelPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1), ItemBracketHandler.getItem("EMT:EMTSolars", 1)), "aer 150, aqua 150, terra 150, ignis 150, ordo 150, perditio 150", ItemBracketHandler.getItem("EMT:EMTSolars", 2), 15)
        Research.addInfusionPage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars", 2))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedChromePlate", 0), arrayOf(ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedChromePlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedChromePlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2), ItemBracketHandler.getItem("EMT:EMTSolars", 2)), "aer 300, aqua 300, terra 300, ignis 300, ordo 300, perditio 300", ItemBracketHandler.getItem("EMT:EMTSolars3", 0), 20)
        Research.addInfusionPage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars3", 0))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 8), arrayOf(ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 8), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 8), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 0)), "aer 600, aqua 600, terra 600, ignis 600, ordo 600, perditio 600", ItemBracketHandler.getItem("EMT:EMTSolars3", 7), 20)
        Research.addInfusionPage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars3", 7))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNaquadriaPlate", 0), arrayOf(ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNaquadriaPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNaquadriaPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7), ItemBracketHandler.getItem("EMT:EMTSolars3", 7)), "aer 1200, aqua 1200, terra 1200, ignis 1200, ordo 1200, perditio 1200", ItemBracketHandler.getItem("EMT:EMTSolars3", 14), 20)
        Research.addInfusionPage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars3", 14))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNeutroniumPlate", 0), arrayOf(ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNeutroniumPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("dreamcraft:item.IrradiantReinforcedNeutroniumPlate", 0), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14), ItemBracketHandler.getItem("EMT:EMTSolars3", 14)), "aer 2400, aqua 2400, terra 2400, ignis 2400, ordo 2400, perditio 2400", ItemBracketHandler.getItem("EMT:EMTSolars4", 5), 20)
        Research.addInfusionPage("CompressedSolars", ItemBracketHandler.getItem("EMT:EMTSolars4", 5))
        Infusion.addRecipe("CompressedSolars", ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 13), arrayOf(ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 13), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("AdvancedSolarPanel:asp_crafting_items", 13), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5), ItemBracketHandler.getItem("EMT:EMTSolars4", 5)), "aer 4800, aqua 4800, terra 4800, ignis 4800, ordo 4800, perditio 4800", ItemBracketHandler.getItem("EMT:EMTSolars4", 12), 20)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.EntropyInfusedSolarPanels", "You know that Solar Panels stop working at nightime. To counter that, you found a way to make your Solar Panels produce energy at night!")
        ...
        Arcane.addShaped("ElectricScribingTools", ItemBracketHandler.getItem("EMT:ElectricScribingTools", 400), "aer 20, ignis 20, aqua 20, ordo 20", arrayOf(arrayOf(OreBracketHandler.getOre("circuitAdvanced"), ItemBracketHandler.getItem("Thaumcraft:ItemInkwell", 0), OreBracketHandler.getOre("circuitAdvanced")), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:ItemInkwell", 0), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("Thaumcraft:ItemInkwell", 0)), arrayOf(OreBracketHandler.getOre("circuitAdvanced"), ItemBracketHandler.getItem("Thaumcraft:ItemInkwell", 0), OreBracketHandler.getOre("circuitAdvanced"))))
        ...
        Infusion.addRecipe("Mjolnirnew", ItemBracketHandler.getItem("EMT:TaintedMjolnir", 0), arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemSwordElemental", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17880), ItemBracketHandler.getItem("EMT:EMTItems", 6), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17880), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("Thaumcraft:FocusShock", 0), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17880), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("EMT:EMTItems", 6), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17880)), "telum 48, tempestas 48, alienis 32, ira 24, aer 16, ignis 16", ItemBracketHandler.getItem("EMT:Mjolnir", 0), 10)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.LightningSummoner", "This item is dropped by your archenemy, the Supercharged Creeper. You feel it is going to be very useful later on.<BR><BR>If you dont't have any luck i have a recipe for you to make this magic balls of lighting")
        Infusion.addRecipe("LightningSummoner", ItemBracketHandler.getItem("Thaumcraft:FocusShock", 0), arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("minecraft:skull", 4), ItemBracketHandler.getItem("minecraft:tnt", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 0), ItemBracketHandler.getItem("minecraft:skull", 4), ItemBracketHandler.getItem("minecraft:tnt", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("minecraft:skull", 4), ItemBracketHandler.getItem("minecraft:tnt", 0)), "tempestas 16, aer 24, ignis 16, nebrisum 8, permutatio 8", ItemBracketHandler.getItem("EMT:EMTItems", 6), 9)
        ...
        Arcane.addShapeless("TinyUranium", ItemBracketHandler.getItem("IC2:itemUran235small", 0).amount(7), "aer 7, ignis 7, aqua 7, terra 7, ordo 7, perditio 7", arrayOf<IIngredient>(ItemBracketHandler.getItem("IC2:itemUran238", 0)))
        ...
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:coal", 1), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("minecraft:coal", 0).amount(16), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:coal", 0))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 4, aqua 4, terra 4, ignis 4, perditio 4, ordo 8", ItemBracketHandler.getItem("minecraft:glowstone", 0), 3)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:glowstone", 0))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:iron_ingot", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5032).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5032))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 11035), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5035).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5035))
        Infusion.addRecipe("UU-MatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 11057), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5057).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5057))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:gold_ingot", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5086).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5086))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("IC2:itemUran238", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5098).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5098))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 11054), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5054).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5054))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 11089), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5089).amount(32), 6)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5089))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:redstone", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 12, aqua 12, terra 24, ignis 12, perditio 12, ordo 24", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5810).amount(24), 9)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5810))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:dye", 4), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 12, aqua 12, terra 24, ignis 12, perditio 12, ordo 24", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5526).amount(24), 9)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 5526))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:iron_ingot", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 8, aqua 8, terra 16, ignis 8, perditio 8, ordo 16", ItemBracketHandler.getItem("minecraft:gold_ingot", 0).amount(2), 9)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:gold_ingot", 0))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:gold_ingot", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 16, aqua 16, terra 32, ignis 16, perditio 16, ordo 32", ItemBracketHandler.getItem("minecraft:diamond", 0), 12)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:diamond", 0))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("minecraft:diamond", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 24, aqua 24, terra 48, ignis 24, perditio 24, ordo 48", ItemBracketHandler.getItem("IC2:itemUran238", 0).amount(2), 15)
        Research.addInfusionPage("UUMatterInfusion", ItemBracketHandler.getItem("IC2:itemUran238", 0))
        Infusion.addRecipe("UUMatterInfusion", ItemBracketHandler.getItem("IC2:itemUran238", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15), ItemBracketHandler.getItem("EMT:EMTItems", 15)), "aer 32, aqua 32, terra 64, ignis 32, perditio 32, ordo 64", ItemBracketHandler.getItem("IC2:itemOreIridium", 0).amount(2), 18)
        ...
        Infusion.addRecipe("ShieldFocus", ItemBracketHandler.getItem("Thaumcraft:FocusPortableHole", 0), arrayOf(ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0), ItemBracketHandler.getItem("gregtech:gt.blockreinforced", 3), ItemBracketHandler.getItem("IC2:itemPartAlloy", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17383), ItemBracketHandler.getItem("gregtech:gt.blockreinforced", 3), ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0), ItemBracketHandler.getItem("gregtech:gt.blockreinforced", 3), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17383), ItemBracketHandler.getItem("IC2:itemPartAlloy", 0), ItemBracketHandler.getItem("gregtech:gt.blockreinforced", 3)), "aer 32, tutamen 40, victus 16, vinculum 24, vitreus 16, praecantatio 8", ItemBracketHandler.getItem("EMT:ShieldFocus", 0), 9)
        ...
        Arcane.addShaped("ShieldBlock", ItemBracketHandler.getItem("EMT:ShieldBlock", 0).amount(10), "terra 20, ordo 20, perditio 20", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 1), ItemBracketHandler.getItem("IC2:itemPartAlloy", 0), ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 1)), arrayOf<IIngredient>(ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0), ItemBracketHandler.getItem("gregtech:gt.blockreinforced", 1), ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 1), ItemBracketHandler.getItem("IC2:itemPartAlloy", 0), ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 1))))
        ...
        Arcane.addShaped("KristmasFocus", ItemBracketHandler.getItem("EMT:ChristmasFocus", 0), "aer 25, ordo 25, aqua 25", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("minecraft:pumpkin", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2728), ItemBracketHandler.getItem("minecraft:pumpkin", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2702), ItemBracketHandler.getItem("Thaumcraft:FocusFrost", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2702)), arrayOf<IIngredient>(ItemBracketHandler.getItem("minecraft:pumpkin", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2728), ItemBracketHandler.getItem("minecraft:pumpkin", 0))))
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.EnergyBallFocus", "It's necessary to put on the BatPack or nano/quant chestplate for using this focus. You need 5120EU to create one ball. It's not recommended for using in a closed space!")
        Infusion.addRecipe("EnergyBallFocus", ItemBracketHandler.getItem("Thaumcraft:FocusShock", 0), arrayOf(ItemBracketHandler.getItem("IC2:blockMachine2", 1), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1461), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1461), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1461), ItemBracketHandler.getItem("IC2:itemBatCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1461)), "potentia 24, praecantatio 18, victus 12, praecantatio 12, cognitio 6", ItemBracketHandler.getItem("EMT:EnergyBallFocus", 0), 6)
        ...
        Infusion.addRecipe(s66, item11, array12, "ignis 64, mortuus 24, motus 48, telum 32, praecantatio 16, potentia 10", ItemBracketHandler.getItem("EMT:ExplosionFocus", 0), 9)
        ...
        Infusion.addRecipe("WandFocusWandCharging", ItemBracketHandler.getItem("EMT:ChargingFocus", 0), arrayOf(ItemBracketHandler.getItem("EMT:EMTMachines", 0), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 20970), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1660), ItemBracketHandler.getItem("IC2:itemBatLamaCrystal", 32767), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1660), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17970), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 20970), ItemBracketHandler.getItem("IC2:itemPartIridium", 0)), "potentia 48, fabrico 32, lucrum 64, permutatio 48, praecantatio 16, cognitio 8, auram 32", ItemBracketHandler.getItem("EMT:WandChargingFocus", 0), 15)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.AuramGenerator", "Though it took a bit more work than you initially thought, you have found a way to produce EU using Auram Essenita. This required a complete reworking of the machine, relying on Auram's pulsating magical power to spin a Generator.")
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.LucrumGenerator", "Your greed kept you going further, so you found a way to convert Lucrum to power.<BR><BR>By Infusing the Potentia Generator with huge amounts of Gold, Permutatio and Lucrum, you managed to build a powerful generator that literally runs on gold.<BR><BR>But as you thought, the Infusion is unstable and will fail easily when you are not prepared.")
        Infusion.addRecipe("LucrumGenerator", ItemBracketHandler.getItem("EMT:EssentiaGenerators", 0), arrayOf(ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0), ItemBracketHandler.getItem("minecraft:gold_block", 0)), "permutatio 128, lucrum 256, praecantatio 32, nebrisum 16", ItemBracketHandler.getItem("EMT:EssentiaGenerators", 5), 10)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.LargeEssentiaGenerator", "This must be it. All your efforts to making the Essentia Generators finally payed of. You managed to make a shematic for a reactor like structure that will allow you to create Energy out of almost anything. The only remaining problems are the Chamber and the Walls of this Structure.")
        Infusion.addRecipe("LargeEssentiaGenerator", ItemBracketHandler.getItem("IC2:blockGenerator", 5), arrayOf(ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1191), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 0), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 1), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 2), ItemBracketHandler.getItem("gregtech:gt.blockmachines", 1191), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 3), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 4), ItemBracketHandler.getItem("EMT:EssentiaGenerators", 5)), "permutatio 1024, praecantatio 512, lucrum 256, radio 128, nebrisum 64, terminus 32", ItemBracketHandler.getItem("gregtech:gt.blockmachines", 13000), 10)
        ...
        MineTweakerAPI.game.setLocalization("tc.research_page.MagicContainingCasings", "The outer layer of your Large Essentia Generator needs to keep the Essential Radiation in place, but needs to be cooled and aswell. The only solution you found in this topic are Force-Fields.")
        Infusion.addRecipe("MagicContainingCasings", ItemBracketHandler.getItem("EMT:EMT_GTBLOCK_CASEING", 4), arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32674), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32674), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0), ItemBracketHandler.getItem("EMT:ShieldBlock", 0)), "ordo 64, tempus 64, praecantatio 64, nebrisum 64, tutamen 512", ItemBracketHandler.getItem("EMT:EMT_GTBLOCK_CASEING", 0), 10)
        ...
        Infusion.addRecipe("IndustrialWandChargingStation", ItemBracketHandler.getItem("Thaumcraft:blockStoneDevice", 5), arrayOf(ItemBracketHandler.getItem("gregtech:gt.blockmachines", 485), ItemBracketHandler.getItem("IC2:itemPartIridium", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 30500), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 6), ItemBracketHandler.getItem("Thaumcraft:blockJar", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 6), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 30500), ItemBracketHandler.getItem("IC2:itemPartIridium", 0)), "permutatio 48, potentia 48, fabrico 48, praecantatio 32, lucrum 64, cognitio 16", ItemBracketHandler.getItem("EMT:EMTMachines", 0), 9)
        ...
        Infusion.addRecipe("EtheralProcessor", ItemBracketHandler.getItem("gregtech:gt.blockmachines", 302), arrayOf(ItemBracketHandler.getItem("gregtech:gt.blockmachines", 262), ItemBracketHandler.getItem("Thaumcraft:blockMetalDevice", 9), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("Thaumcraft:blockWoodenDevice", 0), ItemBracketHandler.getItem("Thaumcraft:blockStoneDevice", 0), ItemBracketHandler.getItem("Thaumcraft:blockWoodenDevice", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("Thaumcraft:blockMetalDevice", 9)), "machina 16, fabrico 16, potentia 24, praecantatio 28, cognitio 8", ItemBracketHandler.getItem("EMT:EMTMachines", 1), 9)
        Research.addInfusionPage("EtheralProcessor", ItemBracketHandler.getItem("EMT:EMTMachines", 1))
        AlloySmelter.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 10), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2880).amount(4), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32307).amount(0), 200, 16)
        Assembler.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 9), ItemBracketHandler.getItem("minecraft:paper", 0).amount(12), ItemBracketHandler.getItem("EMT:EMTItems", 10).amount(4), LiquidBracketHandler.getLiquid("glue").withAmount(6912), 600, 30)
        Assembler.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 9), ItemBracketHandler.getItem("minecraft:paper", 0).amount(12), ItemBracketHandler.getItem("EMT:EMTItems", 10).amount(4), LiquidBracketHandler.getLiquid("refinedglue").withAmount(6912), 600, 30)
        FluidSolidifier.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 8), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32307).amount(0), LiquidBracketHandler.getLiquid("refinedglue").withAmount(288), 100, 16)
        FluidSolidifier.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 8), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32307).amount(0), LiquidBracketHandler.getLiquid("glue").withAmount(288), 100, 16)
        FluidSolidifier.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 10), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32307).amount(0), LiquidBracketHandler.getLiquid("molten.rubber").withAmount(576), 100, 30)
        FluidExtractor.addRecipe(null, ItemBracketHandler.getItem("EMT:EMTItems", 8), LiquidBracketHandler.getLiquid("refinedglue").withAmount(288), 10000, 100, 16)
        FormingPress.addRecipe(ItemBracketHandler.getItem("EMT:EMTItems", 10), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2880).amount(4), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32307).amount(0), 100, 30)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 826).amount(22)), ItemBracketHandler.getItem("Thaumcraft:ItemNugget", 21), intArrayOf(10000), 300, 2)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2880).amount(4)), ItemBracketHandler.getItem("EMT:EMTItems", 10), intArrayOf(10000), 300, 2)
    }
}