...
class ThaumicTinkerer01 : Runnable {
    override fun run() {
        ...
        Infusion.addRecipe("SHARETOME", ItemBracketHandler.getItem("minecraft:skull", 3), arrayOf(ItemBracketHandler.getItem("minecraft:nether_star", 0), ItemBracketHandler.getItem("minecraft:paper", 0), ItemBracketHandler.getItem("Thaumcraft:ItemInkwell", 0), ItemBracketHandler.getItem("Thaumcraft:ItemThaumonomicon", 0), ItemBracketHandler.getItem("minecraft:paper", 0)), "cognitio 32, praecantatio 16, permutatio 32, pannus 16", ItemBracketHandler.getItem("ThaumicTinkerer:shareBook", 0), 6)
        ...
        Arcane.addShaped("DARKQUARTZ", ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), "perditio 8", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz")), arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("coal"), OreBracketHandler.getOre("gemQuartz")), arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"))))
        Arcane.addShaped("DARKQUARTZ", ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), "perditio 8", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz")), arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("charcoal"), OreBracketHandler.getOre("gemQuartz")), arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("gemQuartz"))))
        ...
        MineTweakerAPI.recipes.addShaped(ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzSlab", 0).amount(2), arrayOf(arrayOf(OreBracketHandler.getOre("craftingToolSaw"), ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartz", 0))), null)
        ...
        Arcane.addShaped("INTERFACE", ItemBracketHandler.getItem("ThaumicTinkerer:interface", 0), "ordo 32, perditio 32, terra 16", arrayOf(arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 6), OreBracketHandler.getOre("pipeLargeSteel"), ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 6)), arrayOf(OreBracketHandler.getOre("pipeLargeElectrum"), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 32670), OreBracketHandler.getOre("pipeLargeElectrum")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 6), OreBracketHandler.getOre("pipeLargeSteel"), ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 6))))
        Arcane.addShaped("INTERFACE", ItemBracketHandler.getItem("ThaumicTinkerer:connector", 0), "ordo 16", arrayOf(arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemShard", 1), OreBracketHandler.getOre("screwThaumium"), ItemBracketHandler.getItem("Thaumcraft:ItemShard", 2)), arrayOf(null, ItemBracketHandler.getItem("Forestry:oakStick", 0), OreBracketHandler.getOre("screwThaumium")), arrayOf<IIngredient?>(ItemBracketHandler.getItem("Forestry:oakStick", 0), null, ItemBracketHandler.getItem("Thaumcraft:ItemShard", 3))))
        Research.setAspects("INTERFACE", "ordo 12, perditio 9, potentia 6, aqua 3")
        Research.setComplexity("INTERFACE", 3)
        Arcane.addShaped("DISLOCATOR", ItemBracketHandler.getItem("ThaumicTinkerer:dislocator", 0), "ordo 48, perditio 48, terra 24", arrayOf(arrayOf(OreBracketHandler.getOre("screwThaumium"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 10), OreBracketHandler.getOre("plateEnderPearl")), arrayOf(OreBracketHandler.getOre("circuitBasic"), ItemBracketHandler.getItem("ThaumicTinkerer:interface", 0), OreBracketHandler.getOre("circuitBasic")), arrayOf(OreBracketHandler.getOre("plateEnderPearl"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 10), OreBracketHandler.getOre("screwThaumium"))))
        ...
        Arcane.addShaped("GAS_REMOVER", ItemBracketHandler.getItem("ThaumicTinkerer:gasRemover", 0), "ordo 16, aer 12, perditio 8", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("gemQuartz"), OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("gemQuartz")), arrayOf<IIngredient>(ItemBracketHandler.getItem("ThaumicTinkerer:gaseousLightItem", 0), ItemBracketHandler.getItem("ThaumicTinkerer:interface", 0), ItemBracketHandler.getItem("ThaumicTinkerer:gaseousShadowItem", 0)), arrayOf(ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), OreBracketHandler.getOre("screwThaumium"), ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0))))
        ...
        Infusion.addRecipe(s, item.withTag(ExpandAnyDict.asData(hashMap)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1)), "ignis 10, lux 10, aer 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireFire", 0), 16)
        ...
        Infusion.addRecipe(s3, item2.withTag(ExpandAnyDict.asData(hashMap3)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2)), "aqua 10, lux 10, aer 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireWater", 0), 16)
        ...
        Infusion.addRecipe(s5, item3.withTag(ExpandAnyDict.asData(hashMap5)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3)), "terra 10, lux 10, aer 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireEarth", 0), 16)
        ...
        Infusion.addRecipe(s7, item4.withTag(ExpandAnyDict.asData(hashMap7)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4)), "ordo 10, lux 10, aer 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireOrder", 0), 16)
        ...
        Infusion.addRecipe(s9, item5.withTag(ExpandAnyDict.asData(hashMap9)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0)), "aer 10, lux 10, motus 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireAir", 0), 16)
        ...
        Infusion.addRecipe(s11, item6.withTag(ExpandAnyDict.asData(hashMap11)), arrayOf(ItemBracketHandler.getItem("minecraft:glowstone_dust", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("minecraft:redstone", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0)), "perditio 10, lux 10, aer 10, praecantatio 10", ItemBracketHandler.getItem("ThaumicTinkerer:fireChaos", 0), 16)
        ...
        val array8 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0))
        ...
        val array11 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 1))
        ...
        val array13 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 2))
        ...
        val array15 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3))
        ...
        val array17 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 4))
        ...
        val array19 = arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 5), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 5), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 5), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 5))
        ...
        Arcane.addShaped("FUNNEL", ItemBracketHandler.getItem("ThaumicTinkerer:funnel", 0), "ordo 8, perditio 8, aqua 8", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("craftingToolScrewdriver"), OreBracketHandler.getOre("screwThaumium")), arrayOf<IIngredient>(OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("pipeMediumStainlessSteel"), OreBracketHandler.getOre("plateThaumium"))))
        ...
        Infusion.addRecipe("REPAIRER", ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 4), arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17330), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17032), ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0), ItemBracketHandler.getItem("harvestcraft:hardenedleatherItem", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 7), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17500), ItemBracketHandler.getItem("dreamcraft:item.ReinforcedGlassPlate", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17086)), "fabrico 32, instrumentum 32, ordo 16, praecantatio 16, potentia 8", ItemBracketHandler.getItem("ThaumicTinkerer:repairer", 0), 8)
        ...
        Arcane.addShaped("MAGNETS", ItemBracketHandler.getItem("ThaumicTinkerer:magnet", 0), "aer 30, terra 25, ordo 20, perditio 15", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("plateSteelMagnetic"), OreBracketHandler.getOre("screwThaumium")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), OreBracketHandler.getOre("plateThaumium"), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:blockMagicalLog", 0), ItemBracketHandler.getItem("ThaumicTinkerer:focusTelekinesis", 0), ItemBracketHandler.getItem("Thaumcraft:blockMagicalLog", 0))))
        ...
        Arcane.addShaped("MAGNETS", ItemBracketHandler.getItem("ThaumicTinkerer:magnet", 1), "aer 25, terra 30, ordo 15, perditio 20", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("screwThaumium")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 3), OreBracketHandler.getOre("plateSteelMagnetic"), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0)), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:blockMagicalLog", 1), ItemBracketHandler.getItem("ThaumicTinkerer:focusTelekinesis", 0), ItemBracketHandler.getItem("Thaumcraft:blockMagicalLog", 1))))
        ...
        Arcane.addShaped("ANIMATION_TABLET", ItemBracketHandler.getItem("ThaumicTinkerer:animationTablet", 0), "aer 35, ignis 30, ordo 20", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("plateRoseGold"), OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("plateRoseGold")), arrayOf<IIngredient>(OreBracketHandler.getOre("plateElectrum"), OreBracketHandler.getOre("plateThaumium"), OreBracketHandler.getOre("plateElectrum")), arrayOf(OreBracketHandler.getOre("screwThaumium"), ItemBracketHandler.getItem("Thaumcraft:ItemGolemCore", 100), OreBracketHandler.getOre("screwThaumium"))))
        ...
        Research.setConcealed("INFUSEDPOTIONS", true)
        Infusion.addRecipe("CLEANSING_TALISMAN", ItemBracketHandler.getItem("minecraft:ender_eye", 0), arrayOf(ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), ItemBracketHandler.getItem("minecraft:ghast_tear", 0), ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), ItemBracketHandler.getItem("minecraft:ghast_tear", 0), ItemBracketHandler.getItem("ThaumicTinkerer:darkQuartzItem", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1)), "humanus 32, instrumentum 24, sano 16, victus 16", ItemBracketHandler.getItem("ThaumicTinkerer:cleansingTalisman", 0), 4)
        ...
        Research.setConcealed("INFUSEDPOTIONS", true)
        Arcane.addShaped("PLATFORM", ItemBracketHandler.getItem("ThaumicTinkerer:platform", 0).amount(2), "aer 10, perditio 10", arrayOf(arrayOf<IIngredient>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("craftingToolScrewdriver"), OreBracketHandler.getOre("screwThaumium")), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:blockWoodenDevice", 6), ItemBracketHandler.getItem("Thaumcraft:blockWoodenDevice", 7), ItemBracketHandler.getItem("Thaumcraft:blockWoodenDevice", 6))))
        ...
        Arcane.addShaped("SUMMON", ItemBracketHandler.getItem("ThaumicTinkerer:spawner", 0), "ordo 75, perditio 75, terra 50", arrayOf(arrayOf(OreBracketHandler.getOre("gemFlawlessRuby"), ItemBracketHandler.getItem("Thaumcraft:blockMetalDevice", 5), OreBracketHandler.getOre("gemFlawlessRuby")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 0), OreBracketHandler.getOre("plateDenseObsidian"), ItemBracketHandler.getItem("Thaumcraft:blockCosmeticSolid", 0)), arrayOf<IIngredient>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("craftingToolScrewdriver"), OreBracketHandler.getOre("screwThaumium"))))
        ...
        Arcane.addShaped("FOCUS_SMELT", ItemBracketHandler.getItem("ThaumicTinkerer:focusSmelt", 0), "ignis 16, perditio 12, ordo 12, aer 8", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("Thaumcraft:FocusExcavation", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1), ItemBracketHandler.getItem("minecraft:furnace", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 1)), arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("Thaumcraft:FocusFire", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14))))
        ...
        Infusion.addRecipe("FOCUS_FLIGHT", ItemBracketHandler.getItem("Thaumcraft:ItemSwordElemental", 0), arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 21330), ItemBracketHandler.getItem("EMT:EMTItems", 7), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2532), ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 21330), ItemBracketHandler.getItem("EMT:EMTItems", 7), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2532)), "aer 32, iter 24, motus 32, volatus 24, aer 16", ItemBracketHandler.getItem("ThaumicTinkerer:focusFlight", 0), 6)
        ...
        Arcane.addShaped("FOCUS_ENDER_CHEST", ItemBracketHandler.getItem("ThaumicTinkerer:focusEnderChest", 0), "perditio 50, ordo 50", arrayOf(arrayOf<IIngredient>(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("Thaumcraft:blockMirror", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)), arrayOf(OreBracketHandler.getOre("plateEnderium"), ItemBracketHandler.getItem("Thaumcraft:FocusPortableHole", 0), OreBracketHandler.getOre("plateEnderium")), arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), OreBracketHandler.getOre("plateNetherStar"), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14))))
        ...
        Warp.addToResearch("ANIMATION_TABLET", 3)
        Infusion.addRecipe("FOCUS_TELEKINESIS", ItemBracketHandler.getItem("ThaumicTinkerer:focusFlight", 0), arrayOf(ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17355), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522), ItemBracketHandler.getItem("Thaumcraft:blockCrystal", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17355), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522)), "aer 24, cognitio 32, motus 32, perditio 24, lucrum 16", ItemBracketHandler.getItem("ThaumicTinkerer:focusTelekinesis", 0), 10)
        ...
        Infusion.addRecipe("FOCUS_HEAL", ItemBracketHandler.getItem("Thaumcraft:FocusPech", 0), arrayOf(ItemBracketHandler.getItem("minecraft:golden_apple", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17351), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("minecraft:golden_carrot", 0), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17351), ItemBracketHandler.getItem("Thaumcraft:ItemResource", 14)), "sano 24, spiritus 32, praecantatio 32, victus 24", ItemBracketHandler.getItem("ThaumicTinkerer:focusHeal", 0), 10)
        ...
        Infusion.addRecipe("XP_TALISMAN", ItemBracketHandler.getItem("Thaumcraft:ItemBaubleBlanks", 0), arrayOf(ItemBracketHandler.getItem("Thaumcraft:ItemZombieBrain", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522), ItemBracketHandler.getItem("Thaumcraft:ItemZombieBrain", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17086), ItemBracketHandler.getItem("Thaumcraft:ItemZombieBrain", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17522), ItemBracketHandler.getItem("Thaumcraft:ItemZombieBrain", 0), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 17500)), "bestia 24, lucrum 32, machina 16, permutatio 16, humanus 8", ItemBracketHandler.getItem("ThaumicTinkerer:xpTalisman", 0), 8)
        ...
        Arcane.addShaped("REVEALING_HELM", ItemBracketHandler.getItem("ThaumicTinkerer:revealingHelm", 0), "aer 35, aqua 35, terra 35, ignis 35, ordo 35, perditio 35", arrayOf(arrayOf<IIngredient?>(OreBracketHandler.getOre("screwThaumium"), OreBracketHandler.getOre("craftingToolScrewdriver"), OreBracketHandler.getOre("screwThaumium")), arrayOf(OreBracketHandler.getOre("plateThaumium"), ItemBracketHandler.getItem("Thaumcraft:ItemGoggles", 0), OreBracketHandler.getOre("plateThaumium")), arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("Thaumcraft:ItemHelmetThaumium", 0), null)))
