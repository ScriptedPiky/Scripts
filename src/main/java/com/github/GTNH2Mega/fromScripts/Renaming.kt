...
class Renaming : Runnable {
    override fun run() {
        ...
        IngredientTooltips.addTooltip(item2.withTag(ExpandAnyDict.asData(hashMap2)), MineTweakerAPI.format.lightPurple(ExpandString.asFormattedText("Infinite Energy")))
    }
}