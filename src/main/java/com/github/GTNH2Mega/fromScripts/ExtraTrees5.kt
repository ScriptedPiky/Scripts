...
class ExtraTrees5 : Runnable {
    override fun run() {
        ...
        recipes5.addShaped(item5.withTag(ExpandAnyDict.asData(hashMap5)),
                arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_spruce", 0), null,
        ...
        recipes6.addShaped(item6.withTag(ExpandAnyDict.asData(hashMap6)),
                arrayOf(arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("malisisdoors:item.door_spruce", 0),
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes7.addShaped(item7.withTag(ExpandAnyDict.asData(hashMap7)), arrayOf(arrayOf<IIngredient?>(null, null,
                ItemBracketHandler.getItem("malisisdoors:item.door_spruce", 0)), arrayOfNulls(3), arrayOfNulls(3)),
                null)
        ...
        recipes8.addShaped(item8.withTag(ExpandAnyDict.asData(hashMap8)), arrayOf(arrayOfNulls(3),
                arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_spruce", 0), null, null),
                arrayOfNulls(3)), null)
        ...
        recipes9.addShaped(item9.withTag(ExpandAnyDict.asData(hashMap9)),
                arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_birch", 0), null,
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes10.addShaped(item10.withTag(ExpandAnyDict.asData(hashMap10)),
                arrayOf(arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("malisisdoors:item.door_birch", 0),
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes11.addShaped(item11.withTag(ExpandAnyDict.asData(hashMap11)), arrayOf(arrayOf<IIngredient?>(null, null,
                ItemBracketHandler.getItem("malisisdoors:item.door_birch", 0)), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes12.addShaped(item12.withTag(ExpandAnyDict.asData(hashMap12)), arrayOf(arrayOfNulls(3),
                arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_birch", 0), null, null),
                arrayOfNulls(3)), null)
        ...
        recipes13.addShaped(item13.withTag(ExpandAnyDict.asData(hashMap13)),
                arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_jungle", 0), null,
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes14.addShaped(item14.withTag(ExpandAnyDict.asData(hashMap14)),
                arrayOf(arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("malisisdoors:item.door_jungle", 0),
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes15.addShaped(item15.withTag(ExpandAnyDict.asData(hashMap15)), arrayOf(arrayOf<IIngredient?>(null, null,
                ItemBracketHandler.getItem("malisisdoors:item.door_jungle", 0)), arrayOfNulls(3), arrayOfNulls(3)),
                null)
        ...
        recipes16.addShaped(item16.withTag(ExpandAnyDict.asData(hashMap16)), arrayOf(arrayOfNulls(3),
                arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_jungle", 0), null, null),
                arrayOfNulls(3)), null)
        ...
        recipes17.addShaped(item17.withTag(ExpandAnyDict.asData(hashMap17)),
                arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_acacia", 0), null,
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes18.addShaped(item18.withTag(ExpandAnyDict.asData(hashMap18)),
                arrayOf(arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("malisisdoors:item.door_acacia", 0),
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes19.addShaped(item19.withTag(ExpandAnyDict.asData(hashMap19)), arrayOf(arrayOf<IIngredient?>(null, null,
                ItemBracketHandler.getItem("malisisdoors:item.door_acacia", 0)), arrayOfNulls(3), arrayOfNulls(3)),
                null)
        ...
        recipes20.addShaped(item20.withTag(ExpandAnyDict.asData(hashMap20)), arrayOf(arrayOfNulls(3),
                arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_acacia", 0), null, null),
                arrayOfNulls(3)), null)
        ...
        recipes21.addShaped(item21.withTag(ExpandAnyDict.asData(hashMap21)),
                arrayOf(arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_dark_oak", 0), null,
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes22.addShaped(item22.withTag(ExpandAnyDict.asData(hashMap22)),
                arrayOf(arrayOf<IIngredient?>(null, ItemBracketHandler.getItem("malisisdoors:item.door_dark_oak", 0),
                        null), arrayOfNulls(3), arrayOfNulls(3)), null)
        ...
        recipes23.addShaped(item23.withTag(ExpandAnyDict.asData(hashMap23)), arrayOf(arrayOf<IIngredient?>(null, null,
                ItemBracketHandler.getItem("malisisdoors:item.door_dark_oak", 0)), arrayOfNulls(3), arrayOfNulls(3)),
                null)
        ...
        recipes24.addShaped(item24.withTag(ExpandAnyDict.asData(hashMap24)), arrayOf(arrayOfNulls(3),
                arrayOf<IIngredient?>(ItemBracketHandler.getItem("malisisdoors:item.door_dark_oak", 0), null, null),
                arrayOfNulls(3)), null)
