...
class BiomeoPlenty : Runnable {
    override fun run() {
        ...
        Assembler.addRecipe(ItemBracketHandler.getItem("BiomesOPlenty:misc", 2),
                ...
                ItemBracketHandler.getItem("gregtech:gt.integrated_circuit", 2).amount(0), 120, 20)
        Assembler.addRecipe(ItemBracketHandler.getItem("BiomesOPlenty:hive", 1),
                ...
                ItemBracketHandler.getItem("gregtech:gt.integrated_circuit", 2).amount(0), 400, 40)
        Assembler.addRecipe(ItemBracketHandler.getItem("BiomesOPlenty:rocks", 0),
                ItemBracketHandler.getItem("minecraft:stone", 0),
                ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 2823).amount(4), 50, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 6).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 1), 300, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32414).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 2), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 12).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 4), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 12).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 7), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 14).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 5), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 14).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 2), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 9).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 6), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 9).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 0), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 13).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 7), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 5).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 8), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 5).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 3), 300, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32429).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 9), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32429).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 1), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 7).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers", 15), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 11).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 4), 300, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32418).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 5), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32418).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:mushrooms", 2), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("minecraft:dye", 1).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:flowers2", 8), 300, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32416).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:moss", 0), 300, VoltageLevels.ULV)
        ...
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32417).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:mushrooms", 4), 300, VoltageLevels.ULV)
        Extractor.addRecipe(ItemBracketHandler.getItem("gregtech:gt.metaitem.02", 32417).amount(2),
                ItemBracketHandler.getItem("BiomesOPlenty:plants", 7), 300, VoltageLevels.ULV)
        ...
        FluidSolidifier.addRecipe(ItemBracketHandler.getItem("BiomesOPlenty:honeyBlock", 0),
                ...
                LiquidBracketHandler.getLiquid("for.honey").withAmount(1000), 400, 40)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("minecraft:dye", 15).amount(8)),
                ItemBracketHandler.getItem("BiomesOPlenty:bones", 0), intArrayOf(10000), 300, VoltageLevels.ULV)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("minecraft:dye", 15).amount(12)),
                ItemBracketHandler.getItem("BiomesOPlenty:bones", 1), intArrayOf(10000), 300, VoltageLevels.ULV)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("minecraft:dye", 15).amount(24)),
                ItemBracketHandler.getItem("BiomesOPlenty:bones", 2), intArrayOf(10000), 300, VoltageLevels.ULV)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("dreamcraft:item.SandDust", 0).amount(2),
                ...
                ItemBracketHandler.getItem("BiomesOPlenty:hardSand", 0), intArrayOf(10000, 5000, 1000, 500), 200, 8)
        Pulverizer.addRecipe(arrayOf(ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 1805).amount(2),
                ...
                ItemBracketHandler.getItem("BiomesOPlenty:hardDirt", 0), intArrayOf(10000, 7500, 2500, 2500), 200, 8)
    }
}