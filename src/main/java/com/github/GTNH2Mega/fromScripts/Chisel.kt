...
class Chisel : Runnable {
    override fun run() {
        ...
        Groups.addVariation("redstoneBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickfancy", 8))
        ...
        Groups.addVariation("greenSlimeBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickfancy", 10))
        ...
        Groups.addVariation("blueSlimeBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickfancy", 11))
        ...
        Groups.addVariation("obsidianBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickfancy", 13))
        ...
        Groups.addVariation("manyullynBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickmetal", 3))
        Groups.addVariation("manyullynBricksTCon",
                ItemBracketHandler.getItem("TConstruct:decoration.multibrickmetal", 7))
