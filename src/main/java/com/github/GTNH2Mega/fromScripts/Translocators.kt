...
class Translocators : Runnable {
    override fun run() {
        ...
        ImplosionCompressor.addRecipe(arrayOf(ItemBracketHandler.getItem("Translocator:diamondNugget", 0).amount(2), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 816)), ItemBracketHandler.getItem("gregtech:gt.metaitem.01", 1500), 2)
    }
}